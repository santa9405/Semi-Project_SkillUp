			...
			<div class="col-md-12">
				<div class="tabbable" id="tabs-567607">
					<ul class="nav nav-tabs">
						<li class="nav-item"><a class="nav-link" href="${contextPath}/message/rmessageList">받은 쪽지함</a></li>
						<li class="nav-item"><p class="nav-link">보낸 쪽지함</p></li>
					</ul>
					<div>
						<div>
							<table class="table table-hover">
								<thead>
									<tr height="10px">
										...
										<th width="17%" class="membername">받는사람</th>
										<th>내용</th>
									</tr>
								</thead>
								<tbody>
								<c:forEach var="message" items="${list}">
									<tr height="5px">
										<td width="8%">
											...
											{'memberNo':'${message.receiveMemberNo}'})">${message.receiveMemberName}</a></td>
...
function deletemsg(queryString) {
	...
	case "ok":
		...
		.then(() => {
			location.replace("${contextPath}/message/deleteS?checkedMsgNo=" + queryString);
		})
	}
});
}
