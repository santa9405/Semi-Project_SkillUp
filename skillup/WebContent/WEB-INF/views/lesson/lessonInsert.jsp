...
<body>
	...
	<div class="container my-5" style="padding-left: 40px; padding-right: 40px;">
		<form action="${contextPath}/lesson/insert.do" method="post" enctype="multipart/form-data" role="form" onsubmit="return lessonValidate();">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control div small" id="lessonCnt" name="lessonCnt" min="1" required>
            </div>
        </div>
        <hr>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control div small" id="lessonTime" name="lessonTime" min="1" required>
            </div>
        </div>
        <hr>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <input type="number" class="form-control div small" id="maxNum" name="maxNum" min="1" required>
            </div>
        </div>
        <hr>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control div small" id="lessonDate" name="lessonDate" required>
            </div>
        </div>
        <hr>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control div small" id="price" name="price" min="1" required>
            </div>
        </div>
        <hr>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <div class="col-sm-12" id="imgArea"></div>
            </div>
        </div>
        <hr>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" id="lessonContent" name="lessonContent" rows="10" style="resize: none;" required></textarea>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-12" style="text-align: center;margin-top:30px;">
                <button type="reset" class="btn btn-outline-primary">초기화</button>
                <button type="submit" class="btn btn-primary">수업 등록</button>
            </div>
        </div>
    </form>
	</div>
